...
export const CRONOGRAMA = [
  {
    ...
    selo: 'Dia 1 · Teoria',
    topicos: [
      'Fisiologia e farmacologia aplicada à anestesia',
      'Ventilação mecânica',
      'Bloqueios locorregionais',
      'Manejo de pacientes especiais',
  ...
  },
  {
    ...
    selo: 'Dia 2 · Cadáver',
    topicos: [
      'Aplicação prática de bloqueios locorregionais',
      'Reconhecimento anatômico guiado',
      'Técnicas de acesso vascular e via aérea',
      'Repetição de gesto técnico em ambiente controlado',
    ],
  },
  {
    id: 'domingo',
    ...
    topicos: [
      'Monitorização anestésica real',
      'Condução de casos sob supervisão',
...
export const FAQ = [
  ...
  },
  {
    ...
    resposta:
      'Apenas um calçado fechado. Todo o resto é fornecido pela ASV: roupa cirúrgica, canetas, bloco de anotações e demais materiais do curso.',
  },
  {
